...
public class calculatorParser extends Parser {
	...
	public static final int
		INT=1, PLUS=2, LESS=3, MULT=4, DIV=5, PARENTBER=6, PARENTFECH=7;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "INT", "PLUS", "LESS", "MULT", "DIV", "PARENTBER", "PARENTFECH"
		};
	}
	...
	public static class ParContext extends ExprContext {
		public TerminalNode PARENTBER() { return getToken(calculatorParser.PARENTBER, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode PARENTFECH() { return getToken(calculatorParser.PARENTFECH, 0); }
	...
	public static class OpBinContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof calculatorListener ) ((calculatorListener)listener).enterOpBin(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof calculatorListener ) ((calculatorListener)listener).exitOpBin(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calculatorVisitor ) return ((calculatorVisitor<? extends T>)visitor).visitOpBin(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\7\3\27\n\3\f\3\16\3\32\13\3\3\3\2\3\4\4\2\4\2\4\3\2\6\7\3\2\4\5\2\34"+
		"\2\6\3\2\2\2\4\16\3\2\2\2\6\7\5\4\3\2\7\3\3\2\2\2\b\t\b\3\1\2\t\n\7\b"+
		"\2\2\n\13\5\4\3\2\13\f\7\t\2\2\f\17\3\2\2\2\r\17\7\3\2\2\16\b\3\2\2\2"+
